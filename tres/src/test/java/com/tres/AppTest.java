...
public class AppTest {
	...
	public AppTest() {
		...
		stnMgr1 = new StationManager(map1);
	...
	@Test
	public void testApp() {
		String src = "LTT";		// LOKMANYATILAK
		String dest = "TLV";	// TALVADYA
		String date = "2022-01-13";	// THURSDAY
		...
		// for above src, dest & date, we'll get below output
		res = new String[]{"15017 | KASHI EXP | 2022-02-03T06:52:10",
						"13578 | ROYAL EXP | 2022-02-03T11:52:10"};
